...
(function (global, factory) {
  ...
  var revFormat = {
    ...
    M: function (dateObj, shortMonth, locale) {
      //debugger;
      if (locale.months.shorthand.indexOf(shortMonth) < 0) {
        dateObj.setMonth(parseFloat(shortMonth) - 1);
      } else {
  ...
  var createDateParser = function (_a) {
    var _b = _a.config,
      ...
      _c = _a.l10n,
      l10n = _c === void 0 ? english : _c;
    return function (pdate, givenFormat, timeless) {
      var date = new Date(pdate);
      if (!isValidDate(new Date(pdate))) date = pdate;
    ...
    function buildTime() {
      ...
      if (self.config.enableSeconds) {
        ...
        self.secondElement.setAttribute(
          "data-step",
          self.minuteElement.getAttribute("data-step")
        );
        self.secondElement.setAttribute(
          "data-min",
          self.minuteElement.getAttribute("data-min")
        );
        self.secondElement.setAttribute(
          "data-max",
          self.minuteElement.getAttribute("data-max")
        );
    ...
    function changeYear(newYear) {
      if (
        ...
        (self.currentYearElement.getAttribute("data-max") &&
          newYear > parseInt(self.currentYearElement.getAttribute("data-max")))
      )
        return;
          ...
          case 39:
            if (!isTimeObj) {
              ...
              if (self.daysContainer) {
                ...
                else changeMonth(delta_1, true, undefined, true);
              }
