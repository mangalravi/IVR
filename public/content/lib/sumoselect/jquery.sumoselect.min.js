        ...
        !this.sumo &&
          ...
          ((this.sumo = {
            ...
            createElems: function () {
              ...
              return (
                t.E.wrap(
                  '<div className="SumoSelect" tabindex="0" role="button" aria-expanded="false">'
                ),
                (t.select = t.E.parent()),
                (t.caption = e("<span>")),
                (t.CaptionCont = e(
                  '<p className="CaptionCont SelectBox" ><label><i></i></label></p>'
                )
                ...
                l.outputAsCSV &&
                  ...
                  t.E.attr("name") &&
                  (t.select.append(
                    e('<input className="HEMANT123" type="hidden" />')
                ...
                t.isMobile() && !l.forceCustomRendering
                  ...
                  : (t.E.attr("name") &&
                    ...
                    (t.optDiv = e(
                      '<div className="optWrapper ' + (l.up ? "up" : "") + '">'
                    )),
                    t.floatingList(),
                    (t.ul = e('<ul className="options">')),
            ...
            createLi: function (t, l) {
              ...
              var s = e(
                '<li className="opt"><label>' + t.text() + "</label></li>"
              );
              return (
                s.data("opt", t),
                t.data("li", s),
            ...
            multiSelelect: function () {
              ...
              t.optDiv.addClass("multiple"),
                (t.okbtn = e(
                  '<p tabindex="0" className="btnOk">' + l.locale[0] + "</p>"
                ).click(function () {
                  t._okbtn(), t.hideOpts();
                })),
                (t.cancelBtn = e(
                  '<p tabindex="0" className="btnCancel">' +
                    l.locale[1] +
                    "</p>"
                ).click(function () {
                  t._cnbtn(), t.hideOpts();
              ...
              t.optDiv.append(e('<div className="MultiControls">').append(i)),
            ...
            SelAll: function () {
              ...
              t.is_multi &&
                ((t.selAll = e(
                  '<p className="select-all"><span><i></i></span><label>' +
                    l.locale[2] +
                    "</label></p>"
                )),
            ...
            Search: function () {
              var t = this,
                ...
                s = e('<p className="no-match">');
              (t.ftxt = e(
                '<input type="text" className="search-txt" value="" placeholder="' +
                  l.searchText +
                  '">'
              ).on("click", function (e) {
                e.stopPropagation();
